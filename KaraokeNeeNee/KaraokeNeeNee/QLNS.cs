...
namespace KaraokeNeeNee
{
    public partial class QLNS : Form
    {
        ...
        private void btTKim_Click(object sender, EventArgs e)
        {
            ...
            string sqlTim = "select maNV, gioiTinh, hoTen, diaChi, ngaySinh, email, soDienThoai, tenLoaiNhanVien from NhanVien a join LoaiNhanVien b on a.maLNV = b.maLNV where maNV = @maNV and hoTeN = @hoTen";
